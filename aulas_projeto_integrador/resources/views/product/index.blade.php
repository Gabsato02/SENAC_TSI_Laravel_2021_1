...
<head>
    ...
    <script>
        function confirmDelete(route) {
            if (confirm('Deseja remover o produto?')) window.location = route
            return null;
        }
    </script>
</head>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href='#' onclick="confirmDelete('{{ Route('product.destroy', $product->id) }}');" class='btn btn-sm btn-danger'>Apagar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
